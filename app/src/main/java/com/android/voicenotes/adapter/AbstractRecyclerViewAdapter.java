...
public abstract class AbstractRecyclerViewAdapter<T> extends RecyclerView.Adapter<AbstractRecyclerViewAdapter.ViewHolder> {
    ...
    public AbstractRecyclerViewAdapter(Context context, OnViewHolderClick<T> listener) {
        super();
    ...
    @Override
    public void onBindViewHolder(AbstractRecyclerViewAdapter.ViewHolder holder, int position) {
